...
exports.intersectExtents = exports.mergeExtents = exports.getExtent = exports.LabelledTileGrid = exports.NumericTileGrid = exports.BooleanTileGrid = void 0;
...
function validateAxisExtent(zoom, start, length) {
    if (!(Number.isInteger(start) && start >= 0 && start < Math.pow(2, zoom) &&
...
class BooleanTileGrid extends TileGrid {
    constructor(zoom, x, y, width, height) {
...
exports.BooleanTileGrid = BooleanTileGrid;
class NumericTileGrid extends TileGrid {
...
exports.NumericTileGrid = NumericTileGrid;
class LabelledTileGrid extends TileGrid {
...
exports.LabelledTileGrid = LabelledTileGrid;
(0, threads_1.registerSerializer)({
    ...
    serialize(thing, defaultHandler) {
        if (thing instanceof BooleanTileGrid) {
            return Object.assign(Object.assign({}, thing), { __type: "$$BooleanTileGrid" });
        }
        else if (thing instanceof NumericTileGrid) {
            return Object.assign(Object.assign({}, thing), { __type: "$$NumericTileGrid" });
        }
        else {
...
exports.intersectExtents = intersectExtents;
