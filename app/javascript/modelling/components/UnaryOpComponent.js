...
class UnaryOpComponent extends rete_1.Component {
    ...
    builder(node) {
        ...
        node.addOutput(new rete_1.Output('out', (() => {
            switch (this.affix) {
                case 'prefix':
    ...
    worker(node, inputs, outputs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs['a'].length === 0) {
                ...
                editorNode.meta.output = outputs['out'] = yield workerPool_1.workerPool.queue((worker) => __awaiter(this, void 0, void 0, function* () { return worker.performOperation(this.name, inputs['a'][0]); }));
...
exports.UnaryOpComponent = UnaryOpComponent;
