...
export const Toolbar = ({ backButtonPath, projectName, hasUnsavedChanges, currentTab, isProcessing, setProjectName, saveProject, setCurrentTab, autoProcessing, setAutoProcessing, manualProcessing }: ToolbarProps) => (
