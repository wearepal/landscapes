...
ActiveRecord::Schema.define(version: 2025_03_20_215239) do
  ...
  create_table "expressions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["team_id"], name: "index_expressions_on_team_id"
  end
  ...
  create_table "extents", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["name"], name: "index_extents_on_name", unique: true
    t.index ["team_id"], name: "index_extents_on_team_id"
  end
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["default_team_id"], name: "index_settings_on_default_team_id"
  end
  ...
  add_foreign_key "settings", "teams", column: "default_team_id"
